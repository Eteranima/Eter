...
Os capítulos de conteúdo, o atlas e `v531/` preservam material de design e
...
## Referências de conteúdo e históricas

Os documentos numerados, `atlas/`, `v531/` e handoffs datados servem à
preservação de conteúdo e contexto. Em caso de divergência, os contratos
vigentes acima prevalecem.

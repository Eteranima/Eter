...
test('o jogo local percorre título, escolha, campo, menu e combate', async ({ page }) => {
  const erros: string[] = [];
  ...
  // Save antigo pode existir; zerar o navegador garante um slot vazio real.
  ...
  // 1. TÍTULO — começa aqui, não em campo. A tela oferece três slots (v5.26).
  ...
  // Escolher explicitamente o slot vazio começa jogo novo nele.

  ...
  patio: {
    ...
    decor:[
      ...
      /* `desenharProp` ancora a peça pelo PÉ: a base da imagem cola no
         ...
         casas) por conta própria. A peça traz 32px transparentes à
         direita para compensar isso no próprio canvas; não use
         deslocamento de desenho nem marque o decor como sólido. */
      ...
      {x:6,  y:18, s:'prop_bench_stone_reach_01', solido:true,
       text:'Um banco de madeira polido por muitas conversas entre aulas.'},
      {x:14, y:18, s:'prop_bench_stone_reach_02', solido:true,
       text:'A pedra ainda guarda o frescor da manhã.'},
      {x:28, y:18, s:'prop_bench_stone_reach_03', solido:true,
       text:'O brasão no encosto foi gasto por gerações de estudantes.'},
      {x:7,  y:15, s:'prop_plant_stone_reach_01',
       text:'Flores de éter emitem um brilho suave entre as folhas.'},
      {x:24, y:15, s:'prop_plant_stone_reach_02',
       text:'Alguém cuida deste vaso com paciência de botânico.'},
      {x:33, y:10, s:'prop_plant_stone_reach_03',
